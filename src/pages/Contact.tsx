          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600">contact@anatomylab.com</p>
                </div>
              </div>
            ...
            <div className="mt-12">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-medium text-gray-900">Weekdays</h3>
                  <p className="text-gray-600">9:00 AM - 6:00 PM EST</p>
                </div>
                <div>
                  <h3 className="text-lg font-medium text-gray-900">Weekends</h3>
